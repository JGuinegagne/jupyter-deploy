#!/usr/bin/env python3
"""
Script to upgrade version information across all files in the jupyter-deploy-tf-aws-ec2-jupyterlab template.

Usage:
    python scripts/upgrade_jupyterlab_template_version.py NEW_VERSION
"""
