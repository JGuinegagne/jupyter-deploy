...
class TestTerraformStoreAccessManager(unittest.TestCase):
    ...
    @patch("jupyter_deploy.engine.terraform.tf_backend.cmd_utils.run_cmd_and_capture_output")
    def test_configure_writes_backend_file(self, mock_run: Mock) -> None:
        ...
        self.assertIn('key            = "tf-aws-ec2-base-dep1/engine/terraform.tfstate"', content)
