...
def test_version_consistency() -> None:
    ...
    init_path = project_path / "jupyter_deploy_tf_aws_eks_base" / "__init__.py"
    ...
    manifest_path = project_path / "jupyter_deploy_tf_aws_eks_base" / "template" / "manifest.yaml"
    with open(manifest_path) as f:
        manifest_data = yaml.safe_load(f)
    manifest_version = manifest_data["template"]["version"]

    main_tf_path = project_path / "jupyter_deploy_tf_aws_eks_base" / "template" / "engine" / "main.tf"
