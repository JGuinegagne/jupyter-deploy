...
The operator, router, and Karpenter charts are pulled from OCI or public Helm repositories. Chart versions and OCI references are configurable for testing against staging registries.
